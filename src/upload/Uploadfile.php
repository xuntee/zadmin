...
namespace ZAdmin\upload;

use ZAdmin\upload\driver\Alioss;
use ZAdmin\upload\driver\Local;
use ZAdmin\upload\driver\Qnoss;
use ZAdmin\upload\driver\Txcos;
use think\File;

/**
 * 上传组件
 * Class Uploadfile
 * @package ZAdmin\upload
 */
class Uploadfile
{
